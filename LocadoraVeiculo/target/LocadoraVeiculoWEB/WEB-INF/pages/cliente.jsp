...
<%@taglib prefix="kendo" uri="http://www.kendoui.com/jsp/tags"%>
    ...
    <c:url value="/cliente/create" var="createUrl" />
    <c:url value="/cliente/read" var="readUrl" />
    <c:url value="/cliente/update" var="updateUrl" />
    <c:url value="/cliente/destroy" var="destroyUrl" />
    ...
    <div class="st-content">
        <div class="st-content-inner">
            ...
            <header class="codrops-header">
                <p>Cadastro de <strong>Cliente</strong></p>
            </header>
            ...
            <div class="main clearfix">
                 ...
                 <div class="content" class="k-content">
                    <kendo:grid name="grid" pageable="true" sortable="true" scrollable="true" selectable="true" reorderable="true" resizable="true" height="500">
                        ...
                        <kendo:grid-toolbar>
                            <kendo:grid-toolbarItem name="create" text="Novo Cliente"/>
                        </kendo:grid-toolbar>
                        <kendo:grid-columns>                            
                            <kendo:grid-column title="CPF" field="cpf" width="90px"/>
                            <kendo:grid-column title="Nome" field="nome" width="180px" />
                            <kendo:grid-column title="Endereço" field="endereco" width="150px"/>
                            ...
                            <kendo:dataSource-schema>
                                <kendo:dataSource-schema-model id="id">
                                    <kendo:dataSource-schema-model-fields>
                                        ...
                                        <kendo:dataSource-schema-model-field name="cpf" nullable="false" editable="true">
                                        </kendo:dataSource-schema-model-field>
                                        <kendo:dataSource-schema-model-field name="endereco" nullable="false" editable="true">
                                        </kendo:dataSource-schema-model-field>
